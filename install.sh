...
#webInterfaceGitUrl="https://snscore@dev.azure.com/snscore/snscoreinstaller/_git/snsadmin"
#webInterfaceDir="/var/www/html/admin"
#piholeGitUrl="https://snscore@dev.azure.com/snscore/snscoreinstaller/_git/snscore"
